...
import { Key, NyuScene, Shadow, Star, VaultCard } from '@nyu/scenes';
...
/** Nyu hops and tosses little login cards into a box with the key in it. */
    ...
    <Canvas>
      ...
      {[0, 1, 2].map((index) => (
        <g key={index} className="setup-toss" style={{ animationDelay: `${index * 0.55}s` }}>
          <Sticker edge={12}>
            <VaultCard x={118} y={92} rotate={-12} />
          </Sticker>
        </g>
      ))}
