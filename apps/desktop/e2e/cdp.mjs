// A minimal Chrome DevTools Protocol driver for the UwULock webview.
// Real input events (mouse, keyboard, text insertion), not synthetic DOM
// events, so React sees exactly what a user would produce.
...
export async function connect(port = PORT) {
  ...
  if (!target) throw new Error('no UwULock page on the debugging port');
